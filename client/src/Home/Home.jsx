  ...
  return (
    <div className="font-sans bg-gray-50 text-gray-800">
      ...
      <header className="bg-gray-900 text-white text-center py-6">
        <h1 className="text-4xl font-bold">🚀 SharePod</h1>
      ...
      <section className="bg-white py-12 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="text-2xl font-bold mb-2">Crafted by Aryan Jaiswal</h2>
          <p className="text-gray-600 mb-4">
            Jack of all trades, trying to be master of some.
          </p>
          <div className="flex justify-center space-x-6">
            <a
              href="https://github.com/aeplusjay"
              target="_blank"
      ...
      <footer className="bg-gray-900 text-white text-center py-6">
        <p>&copy; {new Date().getFullYear()} SharePod. All rights reserved.</p>
